...
import other.autoconfig.selector.MyImportDeferredSelector;
...
@Import(MyImportDeferredSelector.class)
@Configuration
@Service
public class MyImportDeferredSelectorAutoConfigTest01 {

    public static void main(String[] args) {
        AnnotationConfigApplicationContext context =
                new AnnotationConfigApplicationContext(MyImportDeferredSelectorAutoConfigTest01.class);
